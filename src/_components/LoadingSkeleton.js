export default function LoadingSkeleton({ count = 6, title = '', grid = false }) {
  return (
    <section className="mb-8">
      <div className="px-4 sm:px-10 lg:px-[200px] mb-4">
        <h2 className="text-xl font-bold text-white">{title || '\u00A0'}</h2>
      </div>
      <div className={grid ? 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 px-4 sm:px-10 lg:px-[200px]' : 'flex gap-3 px-4 sm:px-10 lg:px-[200px] overflow-hidden'}>
