  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto px-1 sm:px-6 lg:px-[200px] my-2 sm:my-4">
      <div className="rounded-md sm:rounded-lg border border-[var(--border-default)] bg-[var(--bg-card)]/50 overflow-hidden">
        ...
        <div className="flex items-center justify-center p-1 sm:p-2 min-h-[50px] sm:min-h-[80px]">
          <div id="container-11cbb31bef16680acc51393f8b8d5af9" className="flex items-center justify-center" />
        </div>
      </div>
    </section>
  )
